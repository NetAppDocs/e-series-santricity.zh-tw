...
---
= 在 SANtricity System Manager 中取得功能金鑰文件
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
.步驟
. 在 System Manager 中，找到並記錄機箱序號。從左側面板，前往選單：Support[Suport Center]，向下捲動至 *View top storage array properties* 即可查看機箱序號。
. 在 System Manager 中，找到 Feature Enable Identifier。從左側面板，前往功能表：Settings[System]，然後向下捲動至 *Add-ons*。尋找 *Feature Enable Identifier*。記錄 Feature Enable Identifier 的編號。
