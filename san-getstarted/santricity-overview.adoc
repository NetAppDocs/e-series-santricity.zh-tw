...
NOTE: EF80、EF50、EF600/EF600C 和 EF300/EF300C 儲存陣列不支援同步鏡像或精簡磁碟區。
...
Unified Manager 是一款以 Web 為基礎的軟體，用於管理您的整個網域。透過集中式檢視，您可以查看所有新型 E-Series 和 EF-Series 陣列的狀態，例如 EF80、EF50、E4000、E2800、EF280、EF300、E5700、EF570、EF600、EF300C 和 EF600C。您也可以對選定的儲存陣列執行批次操作。
